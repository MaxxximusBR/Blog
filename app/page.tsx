...
import AirTrafficSection from '@/components/AirTrafficSection';
    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <a href="https://www.youtube.com/@LuzesAbismo" target="_blank" rel="noopener noreferrer" className="tile group h-36 md:h-40">
            <span className="shine" />
      ...
      <AirTrafficSection lat={-30.033} lon={-51.228} zoom={6} />
    </div>
  );
}
