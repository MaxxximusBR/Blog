...
export default function Landing(){
  return (
    <div className="space-y-12">
      {/* HERO compacto com vídeo à direita */}
      <section className="relative overflow-hidden rounded-3xl border border-[color:var(--border)] bg-gradient-to-b from-indigo-950/40 to-black p-6 md:p-10">
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <p className="mt-3 text-lg text-gray-300">Relatórios mensais, gráficos de tendência e dashboard mundial offline com mapa interativo.</p>
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/reports" className="btn">📄 Ver relatórios</Link>
              <Link href="/dashboard" className="btn">📊 Consolidação</Link>
              <a href="https://www.youtube.com/@LuzesAbismo" target="_blank" className="btn">▶ YouTube</a>
            </div>
          </div>
          <div>
      ...
      {/* MOSAICO interativo (clique navega) */}
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <a href="https://www.youtube.com/@LuzesAbismo" target="_blank" className="tile group h-36 md:h-40">
            <span className="shine" />
