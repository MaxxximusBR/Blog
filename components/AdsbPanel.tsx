...
function zoomToRadiusDeg(z: number) {
  return Math.max(0.3, 12 / Math.max(1, z)); // z=6 → ~5°, z=8 → ~2°, z=10 → ~0.8°
}
...
export default function AdsbPanel({
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-black/20 p-4 md:p-5">
      ...
      {/* Mosaico ilustrativo com vídeos no hover */}
      ...
      <div className="grid md:grid-cols-2 gap-3">
        ...
        <div className="rounded-xl border border-white/10 bg-black/30 p-3 text-xs">
          <div className="rounded-lg overflow-hidden border border-white/10 mb-2 bg-black/40">
            <video className="w-full h-20 md:h-24 object-cover" autoPlay loop muted playsInline preload="metadata" aria-label="Animação de radar de tráfego aéreo">
      ...
      <div className="mt-4 grid gap-3 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-white/10 bg-black/30 p-3">
          ...
          <div className="flex flex-wrap gap-2">
            <a className="btn" href="https://www.liveatc.net/search/?icao=SBPA" target="_blank" rel="noopener noreferrer">LiveATC — buscas SBPA</a>
            <a className="btn" href="https://www.liveatc.net" target="_blank" rel="noopener noreferrer">LiveATC — site</a>
            <a className="btn" href="https://live-atc.vercel.app" target="_blank" rel="noopener noreferrer">Live-ATC (app externo)</a>
          </div>
          <p className="hint mt-2 text-xs">
